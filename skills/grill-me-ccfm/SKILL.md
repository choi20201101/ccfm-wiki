...
description: |
  ...
  코딩 작업뿐 아니라 콘텐츠 기획(영상/이미지/카피), M&A·조직개편 같은 전략 결정,
  출산 준비 같은 개인 영역까지 활용 가능.
...
### 강제 발동 (점수 무시)
다음 키워드는 무조건 grill 진입:
- M&A / 인수 / 매각 / 클로징
- 신제품 출시 / 신규 시장 / 대만 / 동남아
- 산후 / 출산 / 육아 (개인 영역, 되돌리기 어려움)
- 조직개편 / 인사
...
- M&A 클로징(~5/30) 영향? 출산 예정일(5/27) 영향?
- 의사결정자 본인 vs 위임?

**2순위 (Stakeholders)**
- 누구한테 영향? (직원 89명 / 클라이언트 / 컨소시엄)
- 외부 검토 필요? (우영회계법인 / 백영무 부장 / 강용길 부장)
...
같은 주제를 두 모델이 따로 grill 후 **차이점만 사용자에게 제시** → 사용자가 선택. 큰 결정(M&A·신제품·콘텐츠 규제)에 권장.
...
3. ❌ 모든 grill 을 멀티 LLM 으로 — 토큰 낭비. 점수 ≥ 8 또는 강제 발동(M&A 등) 케이스에만.
