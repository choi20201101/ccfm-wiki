...
- ⭐ **광고 카피 자극 7대 후킹** (인용+인지차이/역접·반전/인과·결과/관계·추천/시간·장면/단톡인증/민간요법vs본품) + 18축 cid 시드 결정론 + 풀 사이즈×0.06=cap 공식 (2026-05-03 샤르드 cid 3001~6000 운영) → [[sources/src-charde-cid-3001-6000-axis-system-2026-05-03]]
...
- ⚡ **소재 검수 하네스** (2026-05-14) — [[sources/src-picosera-harness-v1-2026-05-14]] 피코세라 1차 루브릭(체크리스트 25 + 17규칙, 0~5점). "피코세라 하네스 기준으로 필터링해줘" 트리거. 일반화 스킬 `ad-bdh` ([[domains/ai-automation]])
